  ...
  return (
    <main className="container" style={{ marginTop: "6rem" }}>
      ...
      <footer className="footer">
        Love by <a href="https://raghuvaran.vercel.app" target="_blank" rel="noopener noreferrer">Raghuvaran</a>
        <span className="separator">|</span>
        <a href="https://github.com/raghuvaranlokati" target="_blank" rel="noopener noreferrer" className="github-link" title="GitHub Profile">
